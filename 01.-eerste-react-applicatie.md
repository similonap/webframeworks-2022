---
description: >-
  Door een simpele React applicatie te maken zonder alle details te bekijken,
  ontwikkel je een gevoel voor wat React kan.
---
...
![create-react-app maakt veel bestanden aan. In het begin zullen we er niet veel aanpassen.](.gitbook/assets/react-project-folder-contents.png)
...
![De starter applicatie ziet er normaal zo uit in je browser.](.gitbook/assets/screenshot-react-starter.png)
...
{% embed url="https://codesandbox.io/embed/hello-world-o8p978?fontsize=14&hidenavigation=1&theme=light&view=editor" %}
